// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MemberPrincipal.cs" company="An Sinh Comapany">
//   Copyright (c) 2021 AnSinhSCADA contributors
// </copyright>
// <summary>
//   Interaction logic for MemberPrincipal.cs
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace WpfAppServer
{
    ...
    public class MemberPrincipal : IPrincipal
    {
        ...
        SortedList<string, RoleType> _roleDict = new SortedList<string, RoleType>()
            {
                {"General users",RoleType.NONE},{"Operator",RoleType.OP}, {"Controller",RoleType.Electrician}, {"Quality inspector",RoleType.QA}, {"Administrator",RoleType.Admin},
                {"Super administrator",RoleType.NONE|RoleType.OP|RoleType.Electrician|RoleType.QA|RoleType.Admin}
            };
